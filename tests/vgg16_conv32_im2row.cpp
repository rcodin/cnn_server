...
int main() {
	...
	// for (int i = 0; i < output32_conf.h ; i++) {
	// 	for (int j = 0; j < output32_conf.w; j++) {
	// 		for (int k = 0; k < output32_conf.c; k++) {
	// 			int idx = (i * output32_conf.w + j) * output32_conf.c + k;
	// 			cout<<fixed<<setprecision(10)<<output32[idx]<<endl;
	// 		}
	// 	}
	// }
}